...
public class NMTLIST<X> implements IList<X> {
	...
	public int length() {return(1 + this.cdr.length());}
	...
	public IList<X> rest() throws Exception {return(cdr);}
	...
	public IList<X> reverse() { return(revhelper(this, new MTLIST<X>())); }
	...
	public <R> R foldr(IFun2<X,R> f, R res) {return(this.reverse().foldl(f, res));}
