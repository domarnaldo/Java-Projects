...
public class ListTests {
	...
	public void test() {
		...
		L2 = (new MTLIST<String>()).cons("you?").cons("are ").cons("How ").
		cons("pal!").cons("there ").cons("Hi ");
		...
		try {
			...
			assertEquals(N2.filter((n -> n % 2 == 0)).
			equals(N.cons(new Integer(30)).cons(new Integer(30))), true);
			...
			System.out.println("Error ListTest: " + e.getMessage());
		}
	}
